  ...
  for (const key of groupKeys) {
    ...
    for (const p of state.groups[key]) {
      ...
      items += '<li>'
        ...
        + '<div>' + escapeHtml(p) + (_editMode ? '<button class="btn admin-only btn-secondary" style="padding:1px 5px;font-size:.65rem;margin-left:4px;" onclick="promptRename(' + idx + ')">✏️</button>' : '')
